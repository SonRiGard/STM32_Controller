  ...
  while (1)
  {
    /* USER CODE END WHILE */
		if (status == 1){
			...
			TxData[0] = ADC_value[0] & 0xff;
			TxData[1] = ADC_value[0] >> 8;
			TxData[2] = ADC_value[1] & 0xff;
			TxData[3] = ADC_value[1] >> 8;
			TxData[4] = ADC_value[2] & 0xff;
			TxData[5] = ADC_value[2] >> 8;
			TxData[6] = ADC_value[3] & 0xff;
			TxData[7] = ADC_value[3] >> 8;
			}
